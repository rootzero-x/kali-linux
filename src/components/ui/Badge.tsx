...
const badgeVariants = cva(
    "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-slate-950 focus:ring-offset-2 dark:focus:ring-slate-300",
    {
        variants: {
            variant: {
                default: "border-transparent bg-kali-600 text-white hover:bg-kali-700",
                ...
                success: "border-transparent bg-green-500/20 text-green-700 dark:text-green-400 border-green-500/20",
                warning: "border-transparent bg-yellow-500/20 text-yellow-700 dark:text-yellow-400 border-yellow-500/20",
            },
        },
        defaultVariants: {
            variant: "default",
